...
(1, 1, 'aakash', 'aakashpaliwal95@gmail.com', '2018-09-04 08:05:26', 1, 'aakash404', 'e7b0ab597644579afe2bd0c5194a76f707b2bcbf2015c6abbbbc65cfa2dfe73e', '', '0000-00-00 00:00:00', '', ''),
...
(6, 1, '', '', '2018-10-25 05:26:12', 1, 'rooot999', '7933c1fad5d408559ee9cb83f2fcaab69f9c99b51af603c5255f8311f2902268', '', '0000-00-00 00:00:00', '', ''),
...
(8, 1, 'new admin', 'newadmin23@gmail.com', '2018-10-25 05:27:09', 1, 'newadmin23', '46011b5aab12a95bc104e3c7abc184e2d9e0bc7994159ef9b337d781db97cce0', '', '0000-00-00 00:00:00', '', ''),
(9, 1, 'test admin', 'testadmin34@gmail.com', '2018-10-30 05:31:12', 1, 'test admin23', '46011b5aab12a95bc104e3c7abc184e2d9e0bc7994159ef9b337d781db97cce0', '', '0000-00-00 00:00:00', '', '');
...
CREATE TABLE `amc_service` (
  ...
  `log` text NOT NULL COMMENT 'report',
...
(1, 'test2', '0000-00-00 00:00:00', 2, 1, 11, 'testlogs', 1, 2),
...
(10, 'new test employe edit', NULL, 'newedittest34@gmail.com', '8764049758', 0, 1, NULL, NULL, 1),
(11, 'new aakash', '', 'aakashpaliwal95@gmail.com', '8764049857', 1, 1, NULL, NULL, 1);
...
(2, 1, '8000', 'brand test', 'model test', '2016', 1);
...
--
ALTER TABLE `admin`
  MODIFY `admin_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `amc`
--
ALTER TABLE `amc`
  MODIFY `amc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `amc_equip`
--
ALTER TABLE `amc_equip`
  MODIFY `amc_equip_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `amc_service`
--
ALTER TABLE `amc_service`
  MODIFY `amc_service_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `myequipment`
  MODIFY `myequipment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
